...
<div class="page-wrapper">
    ...
    <tr>
        ...
        <td hidden class="id">{{ $subs->id }}</td>
        <td>{{ $subs->subject_code }}</td>
        <td>
            <h2 class="table-avatar">
                <a>{{ $subs->subject_name }}</a>
            </h2>
        </td>
        <td>{{ $subs->department->name }}</td>
        <td>{{ $subs->teacher->full_name }}</td>
        <td>{{ $subs->classroom }}</td>
        <td>{{ $subs->maximum_capacity }}</td>
        <td class="text-end">
            <div class="actions">
                <a href="{{ url('subject/edit/'.$subs->id) }}" class="btn btn-sm bg-danger-light">
                    <i class="feather-edit"></i>
                </a>
                <a href="{{ url('subject/details/'.$subs->id) }}" class="btn btn-sm bg-danger-light">

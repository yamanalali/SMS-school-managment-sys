...
<div class="login-right">
    <div class="login-right-wrap">
        <h1>{{ __('Welcome to Dashbord') }}</h1>
    
        <p class="account-subtitle">{{ __('Need an account?') }} <a href="{{ route('register') }}">{{ __('Sign Up') }}</a></p>
        <h2>{{ __('Sign in') }}</h2>
        ...
        <div class="login-or">
            ...
            <span class="span-or">{{__('Select language')}}</span>
        </div>
        <div class="login-right-wrap">
            <a href="/en"><i class="flag flag-us me-2"></i></a>
            <a href="/ar"><i class="flag flag-sa me-2"></i></a>
            <a href="/tr"><i class="flag flag-tr me-2"></i></a>
        </div>
    </div>
</div>

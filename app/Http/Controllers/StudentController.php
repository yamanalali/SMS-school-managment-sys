    ...
    public function studentSave(Request $request)
    {
        ...
        try {
            ...
            if(!empty($request->upload)) {
                ...
                Toastr::success('Has been add successfully :)','php artisan make:migration create_departments_table --create=departments
');
                DB::commit();
            }
            ...
            DB::rollback();
            Toastr::error_('fail, Add new student  :)','Error');
            return redirect()->back();
        }
    }
